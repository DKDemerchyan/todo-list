...
func NextDate(now time.Time, date string, repeat string) (string, error) {
	...
	case strings.HasPrefix(repeat, "d "):
		return handleDailyRepeat(now, taskStartDate, repeat)

	case strings.HasPrefix(repeat, "w "):
		return handleWeeklyRepeat(now, taskStartDate, repeat)

	case strings.HasPrefix(repeat, "m "):
		return handleMonthlyRepeat(now, taskStartDate, repeat)

	case repeat == "y":
		return handleYearlyRepeat(now, taskStartDate)
...
func handleDailyRepeat(now time.Time, taskStartDate time.Time, repeat string) (string, error) {
...
func handleWeeklyRepeat(now time.Time, taskStartDate time.Time, repeat string) (string, error) {
...
func handleMonthlyRepeat(now time.Time, taskStartDate time.Time, repeat string) (string, error) {
...
func handleYearlyRepeat(now time.Time, taskStartDate time.Time) (string, error) {
